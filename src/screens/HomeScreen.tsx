...
const styles = StyleSheet.create({
  ...
  matchCard: { minHeight: 160, padding: 18, borderRadius: radii.lg, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.line }, headingRow: { flexDirection: 'row', justifyContent: 'space-between' }, cardTitle: { color: colors.ink, fontSize: 25, fontWeight: '900', marginTop: 3 }, matchBody: { marginTop: 25 }, matchTeamsRow: { flexDirection: 'row', alignItems: 'center', gap: 10 }, matchTeams: { flex: 1, color: colors.ink, fontSize: 21, fontWeight: '900', textAlign: 'center' }, matchMeta: { color: colors.muted, fontSize: 13, fontWeight: '700', marginTop: 7 },
