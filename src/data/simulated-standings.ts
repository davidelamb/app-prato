...
export const simulatedHome: Standing[] = sortAndRank([
  buildRow({ club: 'Tau Calcio Altopascio',  played: 4, wins: 3, draws: 1, losses: 0, goalsFor: 9,  goalsAgainst: 1,  form: ['W', 'D', 'W', 'W', 'L'] }),
  buildRow({ club: 'Siena FC',              played: 4, wins: 3, draws: 0, losses: 1, goalsFor: 10, goalsAgainst: 2,  form: ['W', 'W', 'W', 'D', 'W'] }),
  buildRow({ club: 'Lucchese Calcio',        played: 4, wins: 3, draws: 1, losses: 0, goalsFor: 8,  goalsAgainst: 3,  form: ['D', 'W', 'D', 'W', 'W'] }),
  buildRow({ club: 'Ternana Calcio',         played: 4, wins: 3, draws: 0, losses: 1, goalsFor: 9,  goalsAgainst: 5,  form: ['L', 'W', 'W', 'W', 'D'] }),
  buildRow({ club: 'AC Prato',               played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 7,  goalsAgainst: 4,  form: ['W', 'D', 'L', 'W', 'D'] }),
  buildRow({ club: 'Seravezza Pozzi',        played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 6,  goalsAgainst: 3,  form: ['W', 'W', 'L', 'D', 'W'] }),
  buildRow({ club: 'US Città di Pontedera',  played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 5,  goalsAgainst: 4,  form: ['D', 'L', 'D', 'W', 'W'] }),
  buildRow({ club: 'FC Scandicci 1908',      played: 4, wins: 2, draws: 0, losses: 2, goalsFor: 6,  goalsAgainst: 5,  form: ['L', 'W', 'D', 'L', 'W'] }),
  buildRow({ club: 'San Donato Tavarnelle',  played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 5,  goalsAgainst: 5,  form: ['W', 'L', 'W', 'L', 'D'] }),
  buildRow({ club: 'Foligno Calcio 1928',    played: 4, wins: 2, draws: 0, losses: 2, goalsFor: 5,  goalsAgainst: 6,  form: ['D', 'W', 'L', 'W', 'L'] }),
  buildRow({ club: 'Aquila Montevarchi',     played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 5,  goalsAgainst: 7,  form: ['W', 'L', 'L', 'D', 'L'] }),
  buildRow({ club: 'US Follonica Gavorrano', played: 4, wins: 1, draws: 2, losses: 1, goalsFor: 3,  goalsAgainst: 3,  form: ['L', 'D', 'L', 'D', 'W'] }),
  buildRow({ club: 'SC Trestina',            played: 4, wins: 1, draws: 2, losses: 1, goalsFor: 4,  goalsAgainst: 5,  form: ['D', 'L', 'W', 'D', 'L'] }),
  buildRow({ club: 'GSD Ghiviborgo VDS',     played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 4,  goalsAgainst: 6,  form: ['L', 'L', 'W', 'L', 'W'] }),
  buildRow({ club: 'Terranuova Traiana',     played: 4, wins: 0, draws: 2, losses: 2, goalsFor: 2,  goalsAgainst: 5,  form: ['D', 'L', 'D', 'L', 'D'] }),
  buildRow({ club: 'ASD Angelana 1930',      played: 4, wins: 0, draws: 2, losses: 2, goalsFor: 2,  goalsAgainst: 5,  form: ['L', 'D', 'D', 'L', 'L'] }),
  buildRow({ club: 'Rondinella Marzocco',    played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 3,  goalsAgainst: 7,  form: ['L', 'D', 'L', 'L', 'D'] }),
  buildRow({ club: 'Polisportiva Pietralunghese', played: 4, wins: 0, draws: 1, losses: 3, goalsFor: 1, goalsAgainst: 8, form: ['D', 'L', 'L', 'D', 'L'] }),
]);

export const simulatedAway: Standing[] = sortAndRank([
  buildRow({ club: 'Siena FC',              played: 4, wins: 3, draws: 1, losses: 0, goalsFor: 8,  goalsAgainst: 2,  form: ['W', 'W', 'W', 'D', 'W'] }),
  buildRow({ club: 'Ternana Calcio',         played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 7,  goalsAgainst: 5,  form: ['L', 'W', 'W', 'W', 'D'] }),
  buildRow({ club: 'Tau Calcio Altopascio',  played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 5,  goalsAgainst: 4,  form: ['W', 'D', 'W', 'W', 'L'] }),
  buildRow({ club: 'AC Prato',               played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 6,  goalsAgainst: 5,  form: ['W', 'D', 'L', 'W', 'D'] }),
  buildRow({ club: 'Lucchese Calcio',        played: 4, wins: 1, draws: 2, losses: 1, goalsFor: 4,  goalsAgainst: 4,  form: ['D', 'W', 'D', 'W', 'W'] }),
  buildRow({ club: 'Seravezza Pozzi',        played: 4, wins: 2, draws: 1, losses: 1, goalsFor: 5,  goalsAgainst: 5,  form: ['W', 'W', 'L', 'D', 'W'] }),
  buildRow({ club: 'US Città di Pontedera',  played: 4, wins: 1, draws: 2, losses: 1, goalsFor: 5,  goalsAgainst: 5,  form: ['D', 'L', 'D', 'W', 'W'] }),
  buildRow({ club: 'US Follonica Gavorrano', played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 4,  goalsAgainst: 6,  form: ['L', 'D', 'L', 'D', 'W'] }),
  buildRow({ club: 'FC Scandicci 1908',      played: 4, wins: 1, draws: 2, losses: 1, goalsFor: 3,  goalsAgainst: 5,  form: ['L', 'W', 'D', 'L', 'W'] }),
  buildRow({ club: 'San Donato Tavarnelle',  played: 4, wins: 1, draws: 0, losses: 3, goalsFor: 3,  goalsAgainst: 6,  form: ['W', 'L', 'W', 'L', 'D'] }),
  buildRow({ club: 'Foligno Calcio 1928',    played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 4,  goalsAgainst: 7,  form: ['D', 'W', 'L', 'W', 'L'] }),
  buildRow({ club: 'SC Trestina',            played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 2,  goalsAgainst: 7,  form: ['D', 'L', 'W', 'D', 'L'] }),
  buildRow({ club: 'Aquila Montevarchi',     played: 4, wins: 0, draws: 1, losses: 3, goalsFor: 3,  goalsAgainst: 7,  form: ['W', 'L', 'L', 'D', 'L'] }),
  buildRow({ club: 'ASD Angelana 1930',      played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 2,  goalsAgainst: 6,  form: ['L', 'D', 'D', 'L', 'L'] }),
  buildRow({ club: 'GSD Ghiviborgo VDS',     played: 4, wins: 1, draws: 0, losses: 3, goalsFor: 3,  goalsAgainst: 9,  form: ['L', 'L', 'W', 'L', 'W'] }),
  buildRow({ club: 'Terranuova Traiana',     played: 4, wins: 1, draws: 1, losses: 2, goalsFor: 3,  goalsAgainst: 7,  form: ['D', 'L', 'D', 'L', 'D'] }),
  buildRow({ club: 'Rondinella Marzocco',    played: 4, wins: 0, draws: 1, losses: 3, goalsFor: 2,  goalsAgainst: 7,  form: ['L', 'D', 'L', 'L', 'D'] }),
  buildRow({ club: 'Polisportiva Pietralunghese', played: 4, wins: 0, draws: 2, losses: 2, goalsFor: 2, goalsAgainst: 8, form: ['D', 'L', 'L', 'D', 'L'] }),
]);
