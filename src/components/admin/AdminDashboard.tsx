...
export function AdminDashboard({ content, onChange, onReset, onClose }: { content: AppContent; onChange: (next: AppContent) => Promise<void>; onReset: () => Promise<void>; onClose: () => void }) {
  ...
  return <View style={styles.shell}>
    <View style={styles.header}>
      ...
      <Pressable onPress={onClose} style={styles.close}><MaterialCommunityIcons name="close" size={22} color={colors.ink} /></Pressable>
    </View>
    ...
    {view === 'overview' ? <View style={styles.stack}>
      ...
      <View style={adminStyles.panel}>
        ...
        <Button label="Gestisci calendario Prato" icon="calendar-month-outline" onPress={() => setView('calendar')} />
        <Button label="Partite del girone" icon="table-row" onPress={() => setView('group')} />
        ...
        <Button label="Ripristina contenuti" icon="restore" secondary onPress={() => void onReset()} />
      </View>
    </View> : null}
